      ...
      try{
        ...
        .then((data: DataProps) => {
          ...
          const resulData = {
            ...
            fomratedVolume: priceCompact.format(Number(data.data.volumeUsd24Hr))
          }
   ...
   return (
    <div className={styles.container}>
      ...
      <section className={styles.content} >
        <img className={styles.logo} src={`https://assets.coincap.io/assets/icons/${coin?.symbol.toLowerCase()}@2x.png`} alt="logo da moeda" />
        ...
        <a>
          <strong>Mercado:</strong>{coin?.fomratedVolume}
        </a>
        <a>
