    ...
    .then((data:DataProps) =>{
      ...
      const formatedResult = coinsData.map((item) => {
        const formated = {
          ...
          fomratedVolume: priceCompact.format(Number(item.volumeUsd24Hr))
        }
  ...
  return (
    <main className={styles.container}>
      ...
      <form className={styles.form} onSubmit={handleSubmit} >
        <input 
         type="text"
         placeholder="Digite o nome da moeda... Ex biticoin"
         value={input}
      ...
      <table>
        <thead>
          <tr>
            ...
            <th scope='col'>Valor no mercado</th>
